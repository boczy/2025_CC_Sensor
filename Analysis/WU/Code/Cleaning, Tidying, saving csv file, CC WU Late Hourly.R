...
file_path <- "C:/Users/Chris/OneDrive - University of Georgia/Trials/2024/GA Cotton Commission 2024/Data/2024 sensor last data/CC WU Late/Hourly/Raw data Cotton Commission Watkinsville Late_Hourly.dat"
...
file_path_tidy <- file.path(folder_path, "tidy_data_CC_WU_Late_Hourly_cleaned.csv")
file_path_avg <- file.path(folder_path, "AVG_CC_WU_Late_Hourly_cleaned.csv")
file_path_max <- file.path(folder_path, "Max_CC_WU_Late_Hourly_cleaned.csv")
file_path_min <- file.path(folder_path, "Min_CC_WU_Late_Hourly_cleaned.csv")
